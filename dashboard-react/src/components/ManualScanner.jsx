                ...
                <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-6">
                    ...
                    <div className="flex flex-row gap-2 sm:gap-3 w-full xl:w-auto">
                        <button 
                            ...
                            className={clsx(
                                "flex-1 xl:flex-none xl:px-12 py-4 rounded-xl flex items-center justify-center gap-3 group transition-all duration-500",
                        ...
                        >
                            <span className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.15em]">
                                {isAnalyzing ? "Processing Neural Link..." : "Analyze Perimeter"}
                            </span>
